...
namespace FinanceApp
{
    public class Client
    {
        ...
        public int CountPortfolios() { return Portfolios.Count; }  //conta itens na lista

        public Client() { Portfolios = new List<Portfolio>(); } //gera uma lista para um novo cliente 
